export function addNorthreachMap(root: HTMLElement): void {
  ...
  if (!world || world.querySelector('[data-testid="northreach-overlay"]')) return;
  const overlay = document.createElement('div'); overlay.className = 'm9-world-overlay'; overlay.dataset.testid = 'northreach-overlay'; overlay.hidden = true;
